...
WireFramePipelineState::WireFramePipelineState(std::shared_ptr<RootSignatureObject>& rootsignature, const Microsoft::WRL::ComPtr<ID3D12Device>& dev)
{
	...
	D3D12_INPUT_ELEMENT_DESC wireinputDescs[] = {
	...
	gpsDesc.InputLayout.NumElements = sizeof(wireinputDescs) / sizeof(D3D12_INPUT_ELEMENT_DESC);
	gpsDesc.InputLayout.pInputElementDescs = wireinputDescs;
	...
	CreatePipelineState("WireFrame", gpsDesc, dev);
}
