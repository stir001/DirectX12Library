...
public:
	...
	void SetLightObject(const std::shared_ptr<LightObject>& inlight);
	...
	std::shared_ptr<PrimitiveController> CreateCustumPrimitve(const std::shared_ptr<PrimitiveObject>& primitive, const std::string& texPath = "");
